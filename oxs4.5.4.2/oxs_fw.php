<?php
	...
	class oxs_fw{
		...
		function RJsLib($Name,$Param=NULL,$ui_name=NULL){
			return Oxs::G("js.loader")->ReGetObject($Name,$Param, $ui_name);
		}
	...
	class Oxs{		
		...
		static function RJ($Name,$Param=NULL,$ui_name=NULL){
			return Oxs()->RJsLib($Name,$Param,$ui_name);
		}		
