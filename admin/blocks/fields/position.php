...
<?php
	...
	Oxs::I("default:position");

	class fields_position extends default_position{		
		...
		function Exec(){	
			...
			if($CurrentID["block_name"] != $changeId["block_name"]){
				...
				$this->SetAjaxText(
					Oxs::G("message_window")->Error( 
						Oxs::G("languagemanager")->T("positionChangeErrorWrongBlocksNames")  
					)
				);	
